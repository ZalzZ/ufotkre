					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://instagram.com/zalzdev?igshid=OGQ5ZDc2ODk2ZA==" class="hover:underline">
										ZalzDev
									</a>
								</li>
								<li>
									<a href="https://instagram.com/syhrl04_?igshid=OGQ5ZDc2ODk2ZA==" class="hover:underline">
										Syahril
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://instagram.com/ufotkre?igshid=OGQ5ZDc2ODk2ZA==" class="hover:underline ">
										Instagram
									</a>
								</li>
								<li>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas X TKJ 3 | Di Kelola Oleh Siswa TKJ 3
						</p>
					</div>
				</div>
			</div>
